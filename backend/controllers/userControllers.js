...
const usersControllers = {
    ...
    signUpUsers:async (req,res)=>{
        ...
        try {
            ...
            if (usuarioExiste) {
                ...
                if (usuarioExiste.from.indexOf(from) !== -1) { //INDEXOF = 0 EL VALOR EXISTE EN EL INDICE EQ A TRUE -1 NO EXITE EQ A FALSE
                    ...
                    res.json({
                        ...
                        message: "We sent you an email to validate it, please check your box to complete the signUp and add it to your SignIn "
                    }) 
            ...
            console.log(error)
            res.json({ success: false, message: "Something went wrong try again in a few minutes" }) //CAPTURA EL ERROR
        }
    },
